...
func parseConfig() (c *models.ServiceConfig) {
	...
	flag.StringVar(&r.Private, "rsa_private", "./certificates/private.pem", "Path to RSA Private Key")
	flag.StringVar(&r.Public, "rsa_public", "./certificates/public.pem", "Path to RSA Public Key")
	flag.StringVar(&r.Pass, "rsa_pass", "", "RSA PrivateKey Password")
	flag.StringVar(&t.Key, "tls_key", "./certificates/server.key", "Path to TLS Key")
	flag.StringVar(&t.Cert, "tls_cert", "./certificates/server.crt", "Path to TLS Certificate")
