...
var PasswdHashCmp = []struct {
	...
	{"Passwd", "$2a$10$B3Fu0P.r0KRmW4YIx22OAO1opL95XyjpHQF4MbFnVgcpS.BpQGpuS", false},
	{"SomeOtheerPassWdThing", "$2a$10$d5Ekr.5MRSnE7YxC3WAmE.gt9VhgsfYo.mPAGDrtFZXS2nCPtWqsS", false},
	{"MagickHash", "$2a$10$EOmsDTSMWZK6/HqnsybxP.bQ9PFl8peMI65RwsjWkmHx/edkNkEFO", false},
	{"PASSWD", "$2a$10$B3Fu0P.r0KRmW4YIx22OAO1opL95XyjpHQF4MbFnVgcpS.BpQGpuS", true},
	{"Passwd", "$2a$10$B3Fu0P.r0KRmW4HQF4MbFnVgcpS.BpQGpuS", true},
}
...
func TestComparePasswords(t *testing.T) {
	for _, tc := range PasswdHashCmp {
		t.Run(tc.passwd, func(t *testing.T) {
			tc := tc // rebind tc into this lexical scope
			t.Parallel()
			err := ComparePasswords(tc.passwd, tc.hash)
			if err != nil && !tc.expected || err == nil && tc.expected {
